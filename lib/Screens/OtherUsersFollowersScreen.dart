...
class OtherUsersFollowersScreen extends StatefulWidget {
  final String uid;
  OtherUsersFollowersScreen({this.uid});
  @override
  _OtherUsersFollowersScreenState createState() => _OtherUsersFollowersScreenState(uid);
}

class _OtherUsersFollowersScreenState extends State<OtherUsersFollowersScreen> {
  final String uid;
  _OtherUsersFollowersScreenState(this.uid);
