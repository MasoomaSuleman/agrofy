...
// Cancel your subscription when done.
  ...
  //     }
  //     productService.addGallery(product.id, questionImagesList);
  //     setState(() {
  //       questionImagesList = [];
  //       images = [];
  ...
  /* Future postQuestion({String questionString, UserDetails userDetails}) async {
    // setState(() {
    //   isQuploading = true;
    // });
    ...
    _questionToPass.questionByName = userDetails.user_name;
    _questionToPass.questionByUID = userDetails.user_id;
    _questionToPass.questionByProfession = userDetails.userProfession;
    _questionToPass.questionByImageURL = userDetails.user_image_url;
    _questionToPass.questionText = questionString;
    _questionToPass.questionTimeStamp = DateTime.now().toString();
    _questionToPass.questionImages =
        questionImagesList.map((e) => e.toJson()).toList();
    ...
    await _firestore
        ...
        .add(_questionToPass.toMap())
        .then((value) {
      print(
          "AskQuestionScreen()''': New question Is added successfully id: ${value.documentID}");
      // for (var i = 0; i < images.length; i++) {
      //   var img = await saveImage(images[i]);
      //   questionImagesList.add(img);
      // }
  ...
  PdfModel file;
  Future postAQuestion({String questionString, User userDetails}) async {
    // setState(() {
    //   isQuploading = true;
    // });
    if (_imageFile != null) {
    ...
    _questionToPass.questionByName = userDetails.personalInformation.fullName;
    _questionToPass.questionByUID = userDetails.userId;
  ...
  void _showQuestionAddedAlertDialog() {
    ...
    _alertDialogs.showAlertDialogWithOKbutton(context, "Your Question is successfully added ", 3);
  }
